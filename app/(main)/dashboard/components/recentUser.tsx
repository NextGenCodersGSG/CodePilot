...
const ActiveUserDisplay = ({ recentUsers }: ActiveUserDisplayProps) => {
  ...
  return (
    ...
    >
        ...
        {deleteConfirmation.isOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-card border-accent border rounded-lg shadow-xl w-full max-w-md p-6"
            >
              ...
              <div className="flex justify-end gap-3 mt-2">
                <Button
                  variant="outline"
                  className="border-accent hover:bg-muted hover:text-foreground cursor-pointer"
                  onClick={cancelDelete}
      ...
      {/* Main content */}
      <Card className="bg-card border-accent space-y-6">
              ...
              <tbody>
                {recentUsers.map((user) => (
                  <tr
                    ...
                    className="border-b border-accent hover:bg-muted transition-colors"
                  >
                    <td>
