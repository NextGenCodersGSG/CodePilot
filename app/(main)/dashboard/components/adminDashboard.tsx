  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="admin, dashboard, user management, analytics, AI code review, user roles"
        />
        ...
        <meta
          property="og:title"
          content="Admin Dashboard - User Management and Analytics"
        />
        <meta
      ...
      <div className="min-h-screen bg-background text-foreground relative">
        <div className="flex-1">
          ...
          {searchQuery && (
            <motion.div className="fixed inset-0 flex items-center justify-center z-50 bg-background/35">
              <motion.div
              ...
              <div className="flex justify-between items-center">
                ...
                {selectedTab === "users" ? (
                  <Button
                    ...
                    className="bg-ring hover:bg-secondary text-white cursor-pointer "
                  >
                  ...
                  <Card className="bg-card border-accent">
                    <CardHeader>
                      ...
                      <CardDescription className="text-muted-foreground">
                        Active users and new signups per day
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="h-80">
                          ...
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground mt-1">
                                Detailed analysis of user code project
                              </p>
                            </div>
                        ...
                        <div className="p-4 rounded-lg border border-accent bg-muted flex flex-col">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground mt-1">
                                Insights on meeting attendance and engagement
                              </p>
                            </div>
                            <FileText className="h-5 w-5 text-ring" />
                          </div>
                        ...
                        <div className="p-4 rounded-lg border border-accent bg-muted flex flex-col">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground mt-1">
                                AI code review usage statistics
                              </p>
                            </div>
                            <FileText className="h-5 w-5 text-ring" />
                          </div>
