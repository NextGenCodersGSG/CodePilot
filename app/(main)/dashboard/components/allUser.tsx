...
const UserManagementCard = () => {
    ...
    const [filteredUsers, setFilteredUsers] = useState<IUserDocument[]>([]); // State for filtered users
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                const data: IUserDocument[] = await response.json();
                setUsers(data);
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    filteredUsers.map((user,index) => (
                                        <tr key={index} className="border-b border-[#002945] hover:bg-[#001A2C] transition-colors">
