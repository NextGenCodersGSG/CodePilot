        ...
        <Card className="bg-card border-accent">
            <CardHeader>
                <CardTitle>User Engagements Metrics </CardTitle>
                    <CardDescription className="text-muted-foreground">Detailed analytics on user engagement</CardDescription>
            </CardHeader>
            <CardContent>
            <div className="w-full h-full">
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-muted-foreground">{metrics.bugsCount} ({bugsPercentage.toFixed(2)}%)</span>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between mt-6">
                        ...
                        <span className="text-sm text-muted-foreground">{metrics.performanceIssuesCount} ({performancePercentage.toFixed(2)}%)</span>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between mt-6">
                        ...
                        <span className="text-sm text-muted-foreground">{metrics.securityIssuesCount} ({securityPercentage.toFixed(2)}%)</span>
