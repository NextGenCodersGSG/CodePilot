    ...
    const loadData = async () => {
      try {
        ...
        if (sidebarProjects && sidebarProjects.length > 0) {
          const foundProject = sidebarProjects.find(
          ...
          <TabsContent value="all" className="space-y-6">
            ...
            <Card className="bg-card border-accent overflow-hidden pt-0">
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Badge className="bg-muted text-red-500">
                  {project.bugs.length}
                </Badge>
              </CardHeader>
              <CardContent>
                  ...
                  {project.bugs.length > 0 ? (
                    <div className="space-y-4">
                      {project.bugs.map((bug, index) => (
                        <div
                          key={index}
                          className="bg-muted p-4 rounded-lg border border-accent"
                        >
            ...
            <Card className="bg-card border-accent overflow-hidden pt-0">
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Badge className="bg-muted text-green-500">
                  {project.security_issues.length}
                </Badge>
              </CardHeader>
              <CardContent>
                <ScrollArea className="h-[200px] pr-4">
            ...
            <Card className="bg-card border-accent overflow-hidden pt-0">
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Badge className="bg-muted text-yellow-500">
                  {project.performance_issues.length}
                </Badge>
              </CardHeader>
              <CardContent>
                <ScrollArea className="h-[200px] pr-4">
            ...
            <Card className="bg-card border-accent overflow-hidden pt-0">
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Badge className="bg-muted text-blue-500">
                  {project.overall_suggestions.length}
                </Badge>
              </CardHeader>
              <CardContent>
                <ScrollArea className="h-[200px] pr-4">
              ...
              <CardContent>
                {project.bugs.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
                    ...
                    <p>
                      Your code appears to be free of bugs and logical errors.
                    </p>
                  </div>
                )}
              </CardContent>
              ...
              <CardContent>
                {project.security_issues.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
                    ...
                    <p>
                      Your code appears to be secure with no detected
                      vulnerabilities.
                    </p>
                  </div>
                )}
              ...
              <CardContent>
                {project.performance_issues.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
                    ...
                    <p>
                      Your code appears to be optimized with no detected
                      performance issues.
                    </p>
                  </div>
                )}
