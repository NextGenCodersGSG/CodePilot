// ActiveUserDisplay.tsx
import { ICountLogs } from '@/DB/models/count-logs.model';
import { useEffect, useState } from 'react';
import { motion } from 'framer-motion';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@/components/ui/card';
import { cn } from '@/lib/utils';
import { MoreHorizontal, Eye, UserCog, Ban, Trash2 } from 'lucide-react';
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {recentUsers.map((user) => (
                  <tr key={user.userId} className="border-b border-[#002945] hover:bg-[#001A2C] transition-colors">
                  <td>
