            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">
                  Help us improve by sending details about this error to our
                  development team.
                </p>
              ...
              >
                ...
                <p className="text-muted-foreground mb-8">
                  Your report has been sent to our development team. We&apos;ll
                  work on fixing this issue as soon as possible.
                </p>
                <Button
                  onClick={() => router.push("/")}
                  className="bg-primary hover:bg-secondary text-white cursor-pointer"
