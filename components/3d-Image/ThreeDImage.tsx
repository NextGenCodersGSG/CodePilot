...
<div className="absolute right-full mr-8 h-full w-[90%] flex flex-col justify-center space-y-6 z-30">
      <motion.h1 
        ...
        className="text-4xl mb-2 font-bold text-[#00406C]"
      >
        About Us
        </motion.h1>
      <motion.div
        className="mb-2 p-6 bg-gradient-to-r from-[#001523] to-[#001A2C] rounded-xl text-[#F2F2F2] w-80"
        initial={{ x: "-50px", opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ type: "spring", stiffness: 100, damping: 15, delay: 0.1 }}
      >
        <h3 className="text-2xl font-bold mb-2 text-[#00406C]">NextGenCoders</h3>
      ...
      >
        <h3 className="text-2xl font-bold mb-2 text-[#00406C]">Our Mission</h3>
        <p className="text-sm text-[#B3B3B3]">
      ...
      >
        <h3 className="text-2xl font-bold mb-2 text-[#00406C]">Our Expertise</h3>
        <ul className="text-sm text-[#B3B3B3] list-disc pl-5 space-y-1">
